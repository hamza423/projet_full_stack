...
class __TwigTemplate_edf6b854a8ca709762ca5952b5d549ca2467e03af35f2195d02484c0ebb8aa4f extends \Twig\Template
{
    private $source;
...
body {
    ...
    ";
        // line 26
        echo twig_get_attribute($this->env, $this->source, (isset($context["mixins"]) || array_key_exists("mixins", $context) ? $context["mixins"] : (function () { throw new RuntimeError('Variable "mixins" does not exist.', 26, $this->source); })()), "sans_serif_font", []);
        echo "
    font-size: 14px;
    line-height: 1.4;
}
...
";
    ...
    {
        return array (  61 => 26,  50 => 17,  46 => 13,  43 => 9,  41 => 3,);
    }
...
", "@WebProfiler/Profiler/open.css.twig", "/var/www/html/site_final/projetFullStack/vendor/symfony/web-profiler-bundle/Resources/views/Profiler/open.css.twig");
    }
}
