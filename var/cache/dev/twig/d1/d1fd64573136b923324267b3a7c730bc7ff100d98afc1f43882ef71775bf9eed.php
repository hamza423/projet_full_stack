...
class __TwigTemplate_e5a7a81418d66ca9b72d90cf018bc730a4976069682d50b84f5f2a89d1c20f1d extends \Twig\Template
{
    private $source;
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 1
        echo "[exception] ";
        echo (((((isset($context["status_code"]) || array_key_exists("status_code", $context) ? $context["status_code"] : (function () { throw new RuntimeError('Variable "status_code" does not exist.', 1, $this->source); })()) . " | ") . (isset($context["status_text"]) || array_key_exists("status_text", $context) ? $context["status_text"] : (function () { throw new RuntimeError('Variable "status_text" does not exist.', 1, $this->source); })())) . " | ") . twig_get_attribute($this->env, $this->source, (isset($context["exception"]) || array_key_exists("exception", $context) ? $context["exception"] : (function () { throw new RuntimeError('Variable "exception" does not exist.', 1, $this->source); })()), "class", []));
        echo "
[message] ";
        // line 2
        echo twig_get_attribute($this->env, $this->source, (isset($context["exception"]) || array_key_exists("exception", $context) ? $context["exception"] : (function () { throw new RuntimeError('Variable "exception" does not exist.', 2, $this->source); })()), "message", []);
        echo "
";
        // line 3
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["exception"]) || array_key_exists("exception", $context) ? $context["exception"] : (function () { throw new RuntimeError('Variable "exception" does not exist.', 3, $this->source); })()), "toarray", []));
...
";
    ...
    {
        return array (  63 => 5,  54 => 4,  50 => 3,  46 => 2,  41 => 1,);
    }
...
{% endfor %}
", "@Twig/Exception/exception.txt.twig", "/var/www/html/site_final/projetFullStack/vendor/symfony/twig-bundle/Resources/views/Exception/exception.txt.twig");
    }
}
