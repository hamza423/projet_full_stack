...
class __TwigTemplate_7bc82ead92e93837a043c175cdd9e62908617f21524ba86e703f8041bc500139 extends \Twig\Template
{
    private $source;
...
<div class=\"metrics\">
    ...
    ";
        // line 9
        if (twig_get_attribute($this->env, $this->source, (isset($context["request"]) || array_key_exists("request", $context) ? $context["request"] : (function () { throw new RuntimeError('Variable "request" does not exist.', 9, $this->source); })()), "route", [])) {
            // line 10
...
";
        // line 17
        if (twig_get_attribute($this->env, $this->source, (isset($context["request"]) || array_key_exists("request", $context) ? $context["request"] : (function () { throw new RuntimeError('Variable "request" does not exist.', 17, $this->source); })()), "route", [])) {
            // line 18
            echo "    <h3>Route Parameters</h3>

    ";
            // line 20
            if (twig_test_empty(twig_get_attribute($this->env, $this->source, (isset($context["request"]) || array_key_exists("request", $context) ? $context["request"] : (function () { throw new RuntimeError('Variable "request" does not exist.', 20, $this->source); })()), "routeParams", []))) {
                // line 21
...
";
        // line 29
        if (twig_get_attribute($this->env, $this->source, (isset($context["router"]) || array_key_exists("router", $context) ? $context["router"] : (function () { throw new RuntimeError('Variable "router" does not exist.', 29, $this->source); })()), "redirect", [])) {
            // line 30
    ...
    <div class=\"card break-long-words\">
        ";
            // line 34
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["router"]) || array_key_exists("router", $context) ? $context["router"] : (function () { throw new RuntimeError('Variable "router" does not exist.', 34, $this->source); })()), "targetUrl", []), "html", null, true);
            echo "
        ";
            // line 35
            if (twig_get_attribute($this->env, $this->source, (isset($context["router"]) || array_key_exists("router", $context) ? $context["router"] : (function () { throw new RuntimeError('Variable "router" does not exist.', 35, $this->source); })()), "targetRoute", [])) {
                echo "<span class=\"text-muted\">(route: \"";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["router"]) || array_key_exists("router", $context) ? $context["router"] : (function () { throw new RuntimeError('Variable "router" does not exist.', 35, $this->source); })()), "targetRoute", []), "html", null, true);
                echo "\")</span>";
            }
            // line 36
            echo "    </div>
...
<div class=\"card\">
    <strong>Path to match:</strong> <code>";
        // line 42
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["request"]) || array_key_exists("request", $context) ? $context["request"] : (function () { throw new RuntimeError('Variable "request" does not exist.', 42, $this->source); })()), "pathinfo", []), "html", null, true);
        echo "</code>
</div>
...
<table id=\"router-logs\">
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["trace"]) {
            // line 56
            echo "        <tr class=\"";
            echo (((twig_get_attribute($this->env, $this->source, $context["trace"], "level", []) == 1)) ? ("status-warning") : ((((twig_get_attribute($this->env, $this->source, $context["trace"], "level", []) == 2)) ? ("status-success") : (""))));
            echo "\">
            ...
            // line 58
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["trace"], "name", []), "html", null, true);
            echo "</td>
            <td class=\"break-long-words\">";
            // line 59
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["trace"], "path", []), "html", null, true);
            echo "</td>
            <td class=\"font-normal\">
                ";
            // line 61
            if ((twig_get_attribute($this->env, $this->source, $context["trace"], "level", []) == 1)) {
                // line 62
                echo "                    Path almost matches, but
                    <span class=\"newline\">";
                // line 63
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["trace"], "log", []), "html", null, true);
                echo "</span>
                ";
...
";
    ...
    {
        return array (  210 => 72,  194 => 69,  190 => 67,  184 => 65,  182 => 64,  178 => 63,  175 => 62,  173 => 61,  168 => 59,  164 => 58,  160 => 57,  155 => 56,  138 => 55,  122 => 42,  116 => 38,  112 => 36,  106 => 35,  102 => 34,  96 => 30,  94 => 29,  91 => 28,  84 => 25,  78 => 21,  76 => 20,  72 => 18,  70 => 17,  66 => 15,  59 => 11,  56 => 10,  54 => 9,  47 => 5,  41 => 1,);
    }
...
", "@WebProfiler/Router/panel.html.twig", "/var/www/html/site_final/projetFullStack/vendor/symfony/web-profiler-bundle/Resources/views/Router/panel.html.twig");
    }
}
