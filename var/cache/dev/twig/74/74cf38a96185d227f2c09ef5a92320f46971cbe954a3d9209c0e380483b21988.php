...
class __TwigTemplate_9c68028a05390d070effc207aa5bf8c92a0749f12ca53d23ca018121d4eb97f9 extends \Twig\Template
{
    private $source;
...
";
    ...
    <p id=\"<?php echo \$view->escape(\$id); ?>_help\" <?php echo ' '.\$view['form']->block(\$form, 'attributes', ['attr' => \$help_attr]); ?>><?php echo \$view->escape(false !== \$translation_domain ? \$view['translator']->trans(\$help, [], \$translation_domain) : \$help); ?></p>
<?php endif; ?>
", "@Framework/Form/form_help.html.php", "/var/www/html/projet_full_stack/vendor/symfony/framework-bundle/Resources/views/Form/form_help.html.php");
    }
}
